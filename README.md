...
[![GitHub Workflow Status (events)](https://img.shields.io/github/workflow/status/rticommunity/rticonnextdds-examples/Build%20and%20run%20static%20analysis/master)](https://github.com/rticommunity/rticonnextdds-examples/actions/workflows/build.yml)
